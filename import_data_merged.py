...
def import_data(cursor):
    ...
    df_ps = pd.read_csv("projects_sites.csv", sep=';', encoding='latin-1')
    ...
    df_gcs = pd.read_csv("gateways_configs_sensors.csv", encoding='latin-1')
    ...
    df_rd = pd.read_csv(raw_data_files[0], encoding='latin-1')
